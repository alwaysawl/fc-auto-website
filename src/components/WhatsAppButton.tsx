...
export default function WhatsAppButton() {
  return (
    ...
    >
      <span className="absolute inset-0 rounded-full bg-[#25D366] animate-pulse-gold opacity-75" />
      <span className="relative flex items-center gap-3">
        ...
        <span className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300">
