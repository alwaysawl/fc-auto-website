      ...
      <div className="min-w-0">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
          ...
          <button
            ...
            className="lg:hidden px-4 py-2 text-sm font-semibold text-brand-slate bg-white border border-slate-200 rounded-lg shadow-soft"
          >
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-10">
                <button
                  ...
                  disabled={page === 1}
                  className="px-3 py-2 text-sm font-semibold rounded-lg border border-slate-200 text-brand-slate disabled:opacity-40 disabled:cursor-not-allowed hover:bg-slate-50"
                >
                  {t.inventory.prev}
                </button>
        ...
        <div className="mt-auto pt-3 border-t border-slate-100">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link
              ...
              className="h-10 inline-flex items-center justify-center px-2 bg-accent-yellow text-brand-slate text-xs font-semibold rounded-lg hover:bg-accent-yellow-hover transition-colors"
            >
            ...
            <WhatsAppAssignLink
              ...
              className="h-10 inline-flex items-center justify-center gap-1.5 px-2 bg-[#25D366] text-white text-xs font-semibold rounded-lg hover:bg-[#20BD5A] transition-colors"
            >
