...
export default function Header({ locale, t, variant = "dark" }: HeaderProps) {
  ...
  const darkNavLinkClass =
    "text-[15px] font-semibold uppercase tracking-[0.06em] px-2 py-2 rounded-sm whitespace-nowrap flex-shrink-0 transition-colors duration-200 text-gray-300 hover:text-gold hover:bg-white/5";
