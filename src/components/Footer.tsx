      ...
      <div className="container-max section-padding pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="min-w-0">
            ...
            <WhatsAppAssignLink
              sourcePage="footer"
              className="inline-flex items-center gap-3 text-sm hover:text-[#25D366] transition-colors duration-200 group min-w-0"
            >
              ...
              <span className="text-white group-hover:text-[#25D366] transition-colors min-w-0">
                {t.nav.whatsapp}
              </span>
            </WhatsAppAssignLink>
          </div>
