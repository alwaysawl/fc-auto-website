        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <span className="text-white font-display font-bold text-xl block">
                  {t.footer.company}
                </span>
          ...
          <div>
            ...
            <WhatsAppAssignLink
              sourcePage="footer"
              className="inline-flex items-center gap-3 text-sm hover:text-[#25D366] transition-colors duration-200 group"
            >
              <span className="w-10 h-10 bg-[#25D366]/10 border border-[#25D366]/20 rounded-sm flex items-center justify-center group-hover:bg-[#25D366]/20 transition-colors">
              ...
              <span>
                ...
                <span className="text-gray-500">+86 166 7636 4929</span>
              </span>
            </WhatsAppAssignLink>
          </div>
        </div>

        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>
