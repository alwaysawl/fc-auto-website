            ...
            <div className="space-y-8">
              <div className="card-premium p-6 flex gap-5">
                ...
                <div>
                  ...
                  <WhatsAppAssignLink
                    sourcePage="contact"
                    className="btn-whatsapp text-sm inline-flex"
                  >
                    {t.contact.chatNow}
                  </WhatsAppAssignLink>
                  <p className="text-gray-500 text-sm mt-3">+86 166 7636 4929</p>
                </div>
              </div>
              ...
              <div className="card-premium p-6 flex gap-5">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">{t.contact.email}</h3>
                  <p className="text-gray-400 text-sm mb-3">{t.contact.emailDesc}</p>
                  <a href="mailto:info@fcautoexport.com" className="text-gold hover:text-gold-light transition-colors text-sm">
                    info@fcautoexport.com
                  </a>
                </div>
              </div>
              ...
              <div className="card-premium p-6 flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{t.contact.locationDesc}</p>
                </div>
              </div>
            </div>
