            ...
            <div className="space-y-8">
              <div className="card-premium p-5 sm:p-6 flex gap-4 sm:gap-5 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-500 text-sm mt-3 break-all">+86 166 7636 4929</p>
                </div>
              </div>
              ...
              <div className="card-premium p-5 sm:p-6 flex gap-4 sm:gap-5 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <a href="mailto:info@fcautoexport.com" className="text-gold hover:text-gold-light transition-colors text-sm break-all">
              ...
              <div className="card-premium p-5 sm:p-6 flex gap-4 sm:gap-5 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-400 text-sm break-words">{t.contact.locationDesc}</p>
                </div>
              </div>
            </div>
