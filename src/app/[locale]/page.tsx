    ...
    <>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 md:py-28 bg-white">
        <div className="container-max text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-slate tracking-tight mb-6">
            {t.intro.title}
          </h2>
          <p className="text-slate-500 text-lg leading-relaxed">{t.intro.description}</p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 md:py-28 bg-slate-50">
        <div className="container-max">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-slate tracking-tight mb-4">
              {t.whyUs.title}
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {t.whyUs.items.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-soft border border-slate-100 hover:shadow-soft-lg transition-shadow duration-300"
              >
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 md:py-28 bg-white">
        <div className="container-max">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-16 gap-6">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-slate tracking-tight mb-3">
                {t.latestVehicles.title}
              </h2>
              <p className="text-slate-500">Quality inspected vehicles ready for export.</p>
            </div>
            <Link
              href={getLocalizedPath("/inventory", locale)}
              className="inline-flex items-center gap-2 px-6 py-3 bg-accent-yellow text-brand-slate font-semibold rounded-xl hover:bg-accent-yellow-hover shadow-soft transition-all duration-200 text-sm"
            >
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 md:py-28 bg-slate-50">
        <div className="container-max">
          <div className="bg-white rounded-3xl p-10 md:p-16 text-center max-w-3xl mx-auto shadow-soft border border-slate-100">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-slate tracking-tight mb-6">
              {t.cta.title}
            </h2>
            <p className="text-slate-500 text-lg leading-relaxed mb-10">{t.cta.subtitle}</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <WhatsAppAssignLink
                sourcePage="home-cta"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-[#25D366] text-white font-semibold rounded-xl hover:bg-[#20BD5A] shadow-soft transition-all duration-200"
              >
              ...
              <Link
                href={getLocalizedPath("/inventory", locale)}
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-accent-yellow text-brand-slate font-semibold rounded-xl hover:bg-accent-yellow-hover shadow-soft transition-all duration-200"
              >
                {t.cta.browse}
              </Link>
            </div>
